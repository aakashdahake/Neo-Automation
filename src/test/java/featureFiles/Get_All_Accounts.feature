Feature: Functional testing
  ...
  Scenario: User initiates payment and transfer money to another user in another bank
    ...
    Then user transfer amount of "5" "EUR" from "Justo Bank" bank account "IBAN" "NO6404948998640" to "Hizonti Bank" bank account "NO4313081115656" with "sepa-credit" payment method
